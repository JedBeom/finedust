...
func getDataOfNow(stationName string) response {
	var full response
	...
	if err != nil {
		...
		if stationName != "장천동" {
			full = getDataOfNow("장천동")
		} else {
			full = getDataOfNow("연향동")
		}
	}
	return full
}

//Gives you a rate of fine dust
...
//Show The Highest Rate of them and gives you background-color
func MixingRatesAndGiveAHangulRate(Item item) item {
	...
	Item.IsHangulRateLong = isitlong
	return Item
}
